...
func _ready():
	...
	# ambience.play() # This was MUCH easier than having an extra node be a child to the player.
...
func _on_warp_goal_body_entered(body):
	...
	# TODO: https://docs.godotengine.org/en/latest/tutorials/scripting/gdscript/gdscript_basics.html#match
	#match FlickerClock:
		#36001:
		#72001:
